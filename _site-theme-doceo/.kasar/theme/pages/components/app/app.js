...
const methods = {
  ...
  configure(website, docsite, lang, page, params, menu, docmenu) {
    ...
    if (docsite && docsite[lang] && docsite[lang][page]) {
      // It means that it is a docpage.
      this.trmenu.set(website, menu, lang, page, docsite);
      this.mobilemenu.set(website, menu, lang, page, this.doc.getXmlSidemenu(docmenu));
    }
  ...
  fillContent(website, docsite, lang, page, content, docmenu) {
    ...
    if (docsite && docsite[lang] && docsite[lang][page]) {
      // It means that it is a docpage.
      this.doc.fill(content, docmenu, website[lang].home.link);
    }
