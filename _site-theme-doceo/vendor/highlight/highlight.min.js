...
;hljs.registerLanguage("dockerfile",e)})();/*! `http` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("php-template",n)})();/*! `python` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
